  ...
  return (
    <div className="space-y-2">
      <div className="flex items-center gap-2">
        ...
        <span className="text-sm text-text-primary font-medium">Logo</span>
      </div>
      ...
      {logoDataUrl ? (
        <div className="flex items-center gap-3 p-3 bg-secondary/30 border border-border rounded-xl">
          ...
          />
          <span className="flex-1 text-xs text-text-secondary truncate">Logo uploaded</span>
          <button
        ...
        <label className="flex items-center justify-center gap-2 p-4 border-2 border-dashed border-border rounded-xl cursor-pointer hover:border-primary/30 hover:bg-primary-light/30 transition-all">
          <Upload className="w-5 h-5 text-text-secondary" />
          <span className="text-sm text-text-secondary">Upload logo (PNG, JPG, SVG)</span>
          <input
            ref={inputRef}
            type="file"
